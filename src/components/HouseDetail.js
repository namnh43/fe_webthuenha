...
export function HouseDetail() {
    ...
    const {id} = useParams()
    useEffect(()=>{
        axios.get(`http://localhost:8080/house/`+id, {
        }).then(res=>{
                        ...
                        <div className="col-lg-8">
                            <div >
                                ...
                                <div >
                                        {list.map((item) => {
                                            return(
                                                <div><img src={item.fileUrl} alt="Image" className="img-fluid" /></div>
                                            )})}
                                </div>
                            </div>
                                    ...
                                    <div className="col-md-6">
                                        <ul className="property-specs-wrap mb-3 mb-lg-0 float-lg-right">
                                            <li>
                                                ...
                                                <span className="property-specs-number">{house.totalBedrooms} <sup>+</sup></span>
                                            </li>
                                            <li>
                                    ...
                                    {list.map((item) => {
                                        return(
                                            <div className="col-sm-6 col-md-4 col-lg-3">
                                                <a href={item.fileUrl} className="image-popup gal-item"><img src={item.fileUrl} alt="Image" className="img-fluid" /></a>
                                            </div>
                                        )})}
                                </div>
                            </div>
                        ...
                        <div className="col-md-6 col-lg-4 mb-4">
                            <div className="property-entry h-100">
                                ...
                                <div className="p-4 property-body">
                                    ...
                                    <span className="property-location d-block mb-3"><span className="property-icon icon-room"></span> 853 S Lucerne Blvd Unit 101 Los Angeles, CA 90005</span>                                    <strong className="property-price text-primary mb-3 d-block text-success">$2,265,500</strong>
                                    <ul className="property-specs-wrap mb-3 mb-lg-0">
                                        <li>
                                            <span className="property-specs">Beds</span>
                                            <span className="property-specs-number">2 <sup>+</sup></span>
