            ...
            {reviewBookingId !== null ? (
                ...
                <>
                    ...
                    <div className={'mt-2 mb-4'} onChange={search} style={{display: 'flex', flexWrap: 'wrap'}}>
                        <input style={{border: '1px solid #bdbdbd', borderRadius: '5px', paddingLeft: '8px'}}
                               id="search" name="house-name" type="text" placeholder="Search keyword" required/>
                        &nbsp;
                        <select style={{border: '1px solid #bdbdbd', borderRadius: '5px'}} className={'custome-input'}
                            ...
                            <table className="table table-bordered table-hover"
                                ...
                                <tr className={"table-head"}>
                                    <th style={{
                                        ...
                                        <button onClick={idClick}><b>#</b></button>
                                    </th>
                                    <th colSpan="2"
                                        style={{verticalAlign: 'middle', textAlign: 'center', padding: '0px'}}>
                                        <button onClick={houseClick}><b>House</b></button>
                                    </th>
                                    <th style={{
                                        width: '40px',
                                        verticalAlign: 'middle',
                                        ...
                                        <button onClick={sDateClick}><b>Start Date</b></button>
                                    </th>
                                    <th style={{
                                        width: '40px',
                                        verticalAlign: 'middle',
                                        ...
                                        <button onClick={eDateClick}><b>End Date</b></button>
                                    </th>
                                    <th style={{
                                        width: '30px',
                                        verticalAlign: 'middle',
                                        ...
                                        <button onClick={totalClick}><b>Total</b></button>
                                    </th>
                                    <th style={{
                                        width: '160px',
                                        verticalAlign: 'middle',
                                        ...
                                        <button onClick={addressClick}><b>Address</b></button>
                                    </th>
                                    <th style={{
                                        width: '40px',
                                        verticalAlign: 'middle',
                                        ...
                                        return (
                                            <tr key={key}>
                                                ...
                                                <td style={{
                                                    ...
                                                    padding: '5px 0px',
                                                    borderRight: "none"
                                                }}><img src={item.house.images[0].fileUrl}
                                                ...
                                                <td style={{
                                                    ...
                                                    padding: '6px',
                                                    textAlign: 'left'
                                                }}>{item.house.address}</td>
                                                <td style={{
                                                    verticalAlign: 'middle',
                                                    padding: '0px'
                                                }}>{item.bookingStatus}</td>
                                                <td style={{
                                                    verticalAlign: 'middle',
                                                    textAlign: 'center',
                                                    padding: '0px'
